...
#define AST_VIDEOCAP_SEQ_CTRL_COMPRESS_JPEG_FRAME			0x00008000 /* bit 15 */
#define AST_VIDEOCAP_SEQ_CTRL_JPEG                          0x00002000 /* bit 13 */
...
#define AST_VIDEOCAP_JPEG_HDR_BUF_SZ  		SZ_1M
...
#define AST_VIDEOCAP_MAX_FRAME_WIDTH			1920
#define AST_VIDEOCAP_MAX_FRAME_HEIGHT			1200

#if (CONFIG_SPX_FEATURE_GLOBAL_MEMORY_SIZE == 0x3000000) || (CONFIG_SPX_FEATURE_GLOBAL_MEMORY_SIZE == 0x7000000) || \
	(CONFIG_SPX_FEATURE_GLOBAL_MEMORY_SIZE == 0xF000000) || (CONFIG_SPX_FEATURE_GLOBAL_MEMORY_SIZE == 0x1F000000) || defined(SOC_AST2500) || defined(SOC_AST2600)
	#define AST_VIDEOCAP_IN_BUF_SZ						0x900000 /* 9MB */
	#define AST_VIDEOCAP_FLAG_BUF_SZ					(((AST_VIDEOCAP_MAX_FRAME_WIDTH * AST_VIDEOCAP_MAX_FRAME_HEIGHT) / (8 * 8)) * 4)
...
struct ast_videocap_jpeg_tile_info_t {
	uint8_t pos_x;
	uint8_t pos_y;
	uint32_t width;
	uint32_t height;
...
#define MODEDETECTION_VERTICAL_STABLE_MININUM            0x4
#define MODEDETECTION_HORIZONTAL_STABLE_MININUM          0x4
#define MODEDETECTION_VERTICAL_STABLE_THRESHOLD          0x4
#define MODEDETECTION_HORIZONTAL_STABLE_THRESHOLD        0x4
...
#define VIDEOCAP_YUV_SUPPORT 1
#define VIDEOCAP_JPEG_SUPPORT 2
